...
<p> <b>(Method post)</b> you can then check the api from postman or whatever the rest client that you use. URL <b>(method post)</b> http://localhost:8000/offers/  (please note get method not supported  on this (/offers) route)
